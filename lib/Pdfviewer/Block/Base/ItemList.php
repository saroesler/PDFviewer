 ...
 */
class Pdfviewer_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('Pdfviewer:ItemListBlock:', 'Block title::');
    }
    ...
    public function info()
    {
        ...
        if (!ModUtil::available('Pdfviewer')) {
            $requirementMessage .= $this->__('Notice: This block will not be displayed until you activate the Pdfviewer module.');
        }
    
        return array('module'          => 'Pdfviewer',
                     'text_type'       => $this->__('Pdfviewer list view'),
                     'text_type_long'  => $this->__('Display list of Pdfviewer objects.'),
                     'allow_multiple'  => true,
                     'form_content'    => false,
                     'form_refresh'    => false,
                     'show_preview'    => true,
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('Pdfviewer:ItemListBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($blockinfo['title'])) {
            $blockinfo['title'] = $this->__('Pdfviewer items');
        }
    ...
    protected function getSortParam($vars, $repository)
    {
        ...
        if ($vars['sorting'] == 'newest') {
            $idFields = ModUtil::apiFunc('Pdfviewer', 'selection', 'getIdFields', array('ot' => $vars['objectType']));
            if (count($idFields) == 1) {
    ...
    public function update($blockinfo)
    {
        ...
        $vars['objectType'] = $this->request->request->filter('objecttype', 'document', FILTER_SANITIZE_STRING);
