 ...
 */
class Pdfviewer_ContentType_Base_Item extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('Pdfviewer detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single Pdfviewer object.', $dom);
    }
    ...
    public function display()
    {
        if ($this->id != null && !empty($this->displayMode)) {
            return ModUtil::func('Pdfviewer', 'external', 'display', $this->getDisplayArguments());
        }
