 ...
 */
class Pdfviewer_Controller_Base_Ajax extends Zikula_Controller_AbstractAjax
{
    ...
    public function getItemListFinder(array $args = array())
    {
        ...
        if ($this->request->isPost() && $this->request->request->has('ot')) {
            $objectType = $this->request->request->filter('ot', 'document', FILTER_SANITIZE_STRING);
        } elseif ($this->request->isGet() && $this->request->query->has('ot')) {
            $objectType = $this->request->query->filter('ot', 'document', FILTER_SANITIZE_STRING);
        }
        ...
        $entityClass = 'Pdfviewer_Entity_' . ucfirst($objectType);
