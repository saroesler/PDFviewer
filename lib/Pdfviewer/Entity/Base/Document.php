 ...
 *
 * This is the base entity class for document entities.
 *
 * @abstract
 */
abstract class Pdfviewer_Entity_Base_Document extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var Pdfviewer_Entity_Validator_Document The validator for this entity.
     */
    ...
    /**
     * Datei meta data array.
     *
     * @ORM\Column(type="array")
     * @var array $dateiMeta.
     */
    protected $dateiMeta = array();
    ...
    /**
     * The full path to the datei.
     *
     * @var string $dateiFullPath.
     */
    protected $dateiFullPath = '';
    
    /**
     * Full datei path as url.
     *
     * @var string $dateiFullPathUrl.
     */
    protected $dateiFullPathUrl = '';
    /**
    ...
    {
        $this->begindate = \DateTime::createFromFormat('Y-m-d', date('Y-m-d'));
        $this->enddate = \DateTime::createFromFormat('Y-m-d', date('Y-m-d'));
     ...
     * Get _validator.
     *
     * @return Pdfviewer_Entity_Validator_Document
     */
     ...
     * Set _validator.
     *
     * @param Pdfviewer_Entity_Validator_Document $_validator.
     *
     * @return void
     */
    public function set_validator(Pdfviewer_Entity_Validator_Document $_validator = null)
    {
     ...
     * @return string
     */
    public function getDateiFullPath()
    {
        return $this->dateiFullPath;
    }
    
    /**
     * Set datei full path.
     *
     * @param string $dateiFullPath.
     *
     * @return void
     */
    public function setDateiFullPath($dateiFullPath)
    {
        if ($dateiFullPath != $this->dateiFullPath) {
            $this->dateiFullPath = $dateiFullPath;
        }
    }
    
    /**
     * Get datei full path url.
     *
     * @return string
     */
    public function getDateiFullPathUrl()
    {
        return $this->dateiFullPathUrl;
    }
    
    /**
     * Set datei full path url.
     *
     * @param string $dateiFullPathUrl.
     *
     * @return void
     */
    public function setDateiFullPathUrl($dateiFullPathUrl)
    {
        if ($dateiFullPathUrl != $this->dateiFullPathUrl) {
            $this->dateiFullPathUrl = $dateiFullPathUrl;
        }
    }
     ...
     * @return array
     */
    public function getDateiMeta()
    {
        return $this->dateiMeta;
    }
    
    /**
     * Set datei meta.
     *
     * @param array $dateiMeta.
     *
     * @return void
     */
    public function setDateiMeta($dateiMeta = Array())
    {
        if ($dateiMeta != $this->dateiMeta) {
            $this->dateiMeta = $dateiMeta;
        }
    }
    ...
    public function setBegindate($begindate)
    {
        if ($begindate != $this->begindate) {
            if (is_object($begindate) && $begindate instanceOf \DateTime) {
     ...
     *
     * @return Pdfviewer_Entity_Validator_Document The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new Pdfviewer_Entity_Validator_Document($this);
    ...
    public function initWorkflow()
    {
        ...
        $idColumn = 'id';
        $workflowHelper = new Pdfviewer_Util_Workflow(ServiceUtil::getManager());
        ...
        if (!in_array($currentFunc, array('main', 'view', 'display'))) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $this['_objectType'], $idColumn, 'Pdfviewer');
            if (!$result) {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    ...
                    if ($this['createdUserId'] == UserUtil::getVar('uid') || SecurityUtil::checkPermission($component, $instance, ACCESS_ADD)) {
                        $this->_actions[] = array(
                            'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'document', 'id' => $this['id'])),
                            'icon' => 'edit',
                            'linkTitle' => __('Edit', $dom),
                            'linkText' => __('Edit', $dom)
                        );
                        $this->_actions[] = array(
                            'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'document', 'astemplate' => $this['id'])),
                            'icon' => 'saveas',
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'delete', 'arguments' => array('ot' => 'document', 'id' => $this['id'])),
                        'icon' => 'delete',
    ...
    {
        return 'pdfviewer.ui_hooks.documents';
    }
     ...
     *
     * @see Pdfviewer_Entity_Document::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $uploadManager = new Pdfviewer_UploadHandler();
        ...
        if (!empty($this['datei'])) {
            try {
                $basePath = $controllerHelper->getFileBaseFolder('document', 'datei');
            } catch (Exception $e) {
                return LogUtil::registerError($e->getMessage());
            }
            $fullPath = $basePath .  $this['datei'];
            $this['dateiFullPath'] = $fullPath;
            $this['dateiFullPathURL'] = System::getBaseUrl() . $fullPath;
        
            // just some backwards compatibility stuff
            if (!isset($this['dateiMeta']) || !is_array($this['dateiMeta']) || !count($this['dateiMeta'])) {
                // assign new meta data
                $this['dateiMeta'] = $uploadManager->readMetaDataForFile($this['datei'], $fullPath);
            }
        }
     ...
     *
     * @see Pdfviewer_Entity_Document::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see Pdfviewer_Entity_Document::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Pdfviewer_Entity_Document::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see Pdfviewer_Entity_Document::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
    protected function performPostRemoveCallback()
    {
        ...
        foreach ($uploadFields as $uploadField) {
            ...
            $uploadManager->deleteUploadFile('document', $this, $uploadField, $objectId);
        }
     ...
     *     - no creation of other entities allowed
     *
     * @see Pdfviewer_Entity_Document::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see Pdfviewer_Entity_Document::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Pdfviewer_Entity_Document::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see Pdfviewer_Entity_Document::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    public function __clone()
    {
        ...
        if ($this->id) {
            ...
            $entity = new \Pdfviewer_Entity_Document();
            // unset identifiers
            $entity->setId(null);
            // copy simple fields
