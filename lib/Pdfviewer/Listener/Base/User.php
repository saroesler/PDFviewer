 ...
 */
class Pdfviewer_Listener_Base_User
{
    /**
    ...
    public static function delete(Zikula_Event $event)
    {
        ...
        $repo = $entityManager->getRepository('Pdfviewer_Entity_Document');
        // delete all documents created by this user
        $repo->deleteCreator($uid);
        // note you could also do: $repo->updateCreator($uid, 2);
        
        // set last editor to admin (2) for all documents updated by this user
