 ...
 */
class Pdfviewer_Listener_ModuleDispatch extends Pdfviewer_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('Pdfviewer', 'user', 'main'), 'text' => __('Link Text'));
    }
}
