 ...
 * @version Generated by ModuleStudio 0.6.0 (http://modulestudio.de) at Tue Jul 09 15:46:05 CEST 2013.
 */

/**
 * This class provides object meta data for the Tag module.
 */
class Pdfviewer_TaggedObjectMeta_Base_Pdfviewer extends Tag_AbstractTaggedObjectMeta
{
    /**
     * Constructor.
     *
    ...
    function __construct($objectId, $areaId, $module, $urlString = null, Zikula_ModUrl $urlObject = null)
    {
        ...
        $objectType = isset($urlArgs['ot']) ? $urlArgs['ot'] : 'document';
