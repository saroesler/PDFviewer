 ...
 */
class Pdfviewer_Util_Base_Controller extends Zikula_AbstractBase
{
    /**
     * Returns an array of all allowed object types in Pdfviewer.
     *
    ...
    public function getObjectTypes($context = '', $args = array())
    {
        ...
        $allowedObjectTypes[] = 'document';
    
        return $allowedObjectTypes;
    }

    /**
     * Returns the default object type in Pdfviewer.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, actionHandler, block, contentType).
     * @param array  $args    Additional arguments.
     *
    ...
    public function getFileBaseFolder($objectType, $fieldName)
    {
        ...
        $basePath = FileUtil::getDataDirectory() . '/Pdfviewer/';
    
        switch ($objectType) {
            case 'document':
                $basePath .= 'documents/datei/';
            break;
        }
    ...
    public function checkAndCreateUploadFolder($objectType, $fieldName, $allowedExtensions = '')
    {
        ...
        $htaccessFileTemplate = 'modules/Pdfviewer/docs/htaccessTemplate';
