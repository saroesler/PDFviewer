 ...
 */
class Pdfviewer_Util_Base_ListEntries extends Zikula_AbstractBase
{
    /**
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'document':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForDocument();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries.
     */
    public function getWorkflowStateEntriesForDocument()
    {
        $states = array();
